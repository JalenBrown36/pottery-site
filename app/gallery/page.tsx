...
import VideoGrid from "../ui/pages/VideoGrid";

export default function Page() {
  return (
    <div className="w-full mx-auto text-center">
      <section className="w-full pb-4 bg-mainBg bg-fixed">
        ...
        <section className="w-[80%] pt-8 mb-8 mx-auto flex flex-row justify-center items-center gap-4 border-t-1 border-[#AF5C42]">
          <div className="w-[350px] flex flex-col gap-2 text-left">
            <div>
              <h4>Staff project picks for November</h4>
              <p>
            ...
            <div>
              <h4>Got a minute (like, literally – 60 seconds)?</h4>
              <p>
                See how easy it is to paint like a pro! It’s all about the
                techniques, so we put together 12 SHORT videos, each
                highlighting an EASY technique that will take your painting to a
                new level of awesomeness! Seriously, each video is just 60
                seconds!
              </p>
            </div>
          </div>
      ...
      <section className="w-[80%] pt-4 pb-8 mx-auto">
        <VideoGrid />
      </section>
    </div>
  );
